...
| compound-extractor | Compound Extractor | productivity | stub (logging live) |
...
- **Compound Extractor** → self-reinforcing loops, habits, and systems visible so advantages grow without constant input

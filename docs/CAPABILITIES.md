...
- **Assumption Extractor** → hidden premises visible early, less rework on false foundations
- **Constraint Extractor** → real bounds visible early, effort stays inside what is possible

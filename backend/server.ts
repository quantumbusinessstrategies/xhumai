...
// Note: truncated original had more entity/self/pulse routes; keeping core intact for this wiring.

app.listen(PORT, HOST, () => {
  console.log(`XhumAI Quantum Core listening on http://${HOST}:${PORT}`);
});
